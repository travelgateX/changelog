...
// ConnectionArguments : to properly initialize default values
...
// CursorForObjectInConnection :Return the cursor associated with an object in an array.
